...
┃┃─┃┃┃───┃┃┃┗━┛┃┏┛┗┛┃┏┛┗┓┃┃───┃┗━┛┃ 
┗┛─┗━┛───┗┛┗━━━┛┗━━━┛┗━━┛┗┛───┗━━━┛ 
\x1b[1;91m•\x1b[1;93m•\x1b[1;92m• \033[47m\x1b[1;94m𝐄𝐍𝐉𝐎𝐘 𝐘𝐎𝐔𝐑 𝐓𝐈𝐌𝐄 𝐖𝐈𝐓𝐇 𝐂𝐑𝐀𝐂𝐊\33[m \x1b[1;92m•\x1b[1;93m•\x1b[1;91m•\33[m

{m} ☯︎ {k} ☯︎ {h} ☯︎ {sir} DEVELOPED BY : Naldi Fanxmoody{x}{m} ☯︎ {k} ☯︎ {h} ☯︎ {x}''')
#--------------------[ BAGIAN-MASUK ]--------------#
def login():
	try:
...
def login_lagi334():
	try:
		os.system('clear')
		banner()
		cetak(nel('\t( ͠° ͟ʖ ͡°) DEVELOPED BY : [green]🇨 🇴 🇰 🇮  [white] Naldi Fanxmoody'))
		asu = random.choice([m,k,h,b,u])
		cookie=input(f'  [{h}•{x}] Masukkan Cookie :{asu} ')
...
#-------------[ PENGATURAN-IDZ ]---------------#
def setting():
	print(f'{x}>> 1. Akun JANDA (NOT RECOMMENDED) ')
